...
<body>
    ...
    <?php 
        session_start();
        if(!isset($_POST['sesion_iniciada'])){
            $_POST['sesion_iniciada'] = false;
        }
    ?>
    ...
    <div class="container contenedor_padre">
        ...
        <?php if($_SESSION["sesion_iniciada"] == true): ?>
        <div class="row p-2">
            <p>
                Tienes la sesión iniciada como administrador:
            </p>
            <a href="back/admin.php">
                <button class="btn btn-warning w-100">Acceder al back</button>
            </a>
        </div>
        <?php endif; ?>
